...
const MessagingPage = () => {
  ...
  return (
    <View className="flex-1 bg-gray-100">
      {/* Header */}
      <View className="p-4 flex-row items-center shadow-lg shadow-black" style={{ backgroundColor: "#59AFFF" }}>
        <Image source={require("../assets/images/user (1).png")} className="w-10 h-10 rounded-full" />
        <Text className="text-purple-900 text-2xl ml-3" style={{ fontFamily: "PoppinsBold" }}>John Doe</Text>
      </View>
      ...
      <View className="flex-row items-center bg-white p-3 border-t border-gray-200">
        ...
        />
        <TouchableOpacity className="ml-3 p-3 bg-purple-900 rounded-full">
