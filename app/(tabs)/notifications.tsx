...
const Notifications = () => {
  ...
  return (
    <View className="flex-1 bg-gray-100">
      {/* Header */}
      <View className="flex-row items-center justify-between p-6 rounded-b-lg shadow-lg shadow-black" style={{
    backgroundColor: "#59AFFF",
  }}>
        <Text className="text-purple-900 text-2xl font-bold">Notifications</Text>
